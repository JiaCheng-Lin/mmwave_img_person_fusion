...
def get_mmwave_regression_pts(mmwave_json, origin_px=6.0, origin_py=1.0): # # origin_px/py: jorjin Device original point 
    xy_list = [] 
    MMWs = [] # save all MMW()
    ...
    for i in range(detection): 
        ID, px, py, vx, vy, Ax, Ay = mmwave_json["JsonTargetList"][i]["ID"], \
